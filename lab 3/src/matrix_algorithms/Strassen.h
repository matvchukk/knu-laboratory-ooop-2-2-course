...
class Strassen {
public:
    static ComplexMatrix* regular_mult(ComplexMatrix* a, ComplexMatrix* b) {
    ...
    static ComplexMatrix* Strassen_rec(ComplexMatrix* a, ComplexMatrix* b) {
        int N = a->get_columns();
        int M = a->get_rows();
        int Q = b->get_columns();
        if (N <= 8 || M <= 8 || Q <= 8) {
        ...
        ComplexMatrix* M1 = Strassen_rec(&D1, &D2);
        ComplexMatrix* M2 = Strassen_rec(&D3, &b11);
        ComplexMatrix* M3 = Strassen_rec(&a11, &D4);
        ComplexMatrix* M4 = Strassen_rec(&a22, &D5);
        ComplexMatrix* M5 = Strassen_rec(&D6, &(b22));
        ComplexMatrix* M6 = Strassen_rec(&D7, &D8);
        ComplexMatrix* M7 = Strassen_rec(&D9, &D10);
    ...
    static ComplexMatrix* strassenRec(ComplexMatrix* a, ComplexMatrix* b) {
